...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass, tabsSelectorTarget) {
    // Tabs
    ...
    tabsParent.addEventListener('click', (event) => {
        ...
        if (target && target.classList.contains(tabsSelectorTarget)) {
            tabs.forEach((item, i) => {
                if (target == item) {
                    hideTabContent();
                    showTabContent(i);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active'.slice(1), 'tabheader__item');
